...
macro_rules! wasi_component_run {
    ($test:expr) => {
...
fn test_get_cpu_info() {
    wasi_component_run!("test-get-cpu-info");
}

#[test]
fn test_get_disks() {
    wasi_component_run!("test-get-disks");
}

#[test]
fn test_get_interrupts_info() {
    wasi_component_run!("test-get-interrupts-info");
}

#[test]
fn test_get_memory_info() {
    wasi_component_run!("test-get-memory-info");
}

#[test]
fn test_get_networks() {
    wasi_component_run!("test-get-networks");
}

#[test]
fn test_get_processes() {
    wasi_component_run!("test-get-processes");
}

#[test]
fn test_get_rps_info() {
    wasi_component_run!("test-get-rps-info");
}

#[test]
fn test_get_system_info() {
    wasi_component_run!("test-get-system-info");
}
